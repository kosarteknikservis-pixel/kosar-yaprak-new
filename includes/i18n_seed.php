...
function i18n_translation_catalog(): array
{
    ...
    return [
        ...
        'shop.your_cart' => ['shop', 'SEPETİNİZ', 'YOUR CART', 'سلتك'],
        'shop.ship_first_day' => ['shop', 'Kargonuz ilk iş günü içerisinde kargoya verilecektir.', 'Your order will be shipped on the first business day.', 'سيتم شحن طلبك في أول يوم عمل.'],
        'shop.ship_1_3' => ['shop', 'Kargonuz 1–3 iş günü içinde kargoya verilir.', 'Your order will be shipped within 1–3 business days.', 'سيتم شحن طلبك خلال 1–3 أيام عمل.'],
        'shop.promo_august' => ['shop', 'AĞUSTOS AYI TEK FİYAT', 'AUGUST SINGLE PRICE', 'سعر واحد لشهر أغسطس'],
        'shop.promo_summer' => ['shop', 'YAZ İÇİN SON İNDİRİM BUGÜN', 'LAST SUMMER DISCOUNT TODAY', 'آخر خصم للصيف اليوم'],
        'shop.promo_month' => ['shop', 'EKİM AYI TEK FİYAT', 'THIS MONTH SINGLE PRICE', 'سعر واحد لهذا الشهر'],
        'shop.promo_single' => ['shop', 'TEK FİYAT', 'SINGLE PRICE', 'سعر واحد'],
        'shop.certified_secure' => ['shop', 'Bu Web Sitesi Sertifikalı Güvenlidir', 'This website is certified secure', 'هذا الموقع آمن ومعتمد'],
        'shop.privacy_note' => ['shop', 'Bilgileriniz saklanmaz ve 3. kişiler ile kesinlikle paylaşılmaz', 'Your information is not stored and is never shared with third parties', 'لا يتم حفظ بياناتك ولا تُشارك مع أي طرف ثالث'],
        'shop.safe_shopping' => ['shop', 'Güvenli alışveriş', 'Secure shopping', 'تسوق آمن'],
        'cd.deal' => ['countdown', 'FIRSAT', 'DEAL', 'عرض'],
        'cd.ending' => ['countdown', 'Süre Dolmak Üzere!', 'Ending soon!', 'ينتهي قريباً!'],
        'footer.tile_cod_cash' => ['footer', 'Kapıda nakit ödeyin, ürünü görün.', 'Pay in cash when your order arrives.', 'ادفع نقداً عند وصول الطلب.'],
        'footer.tile_cod_card' => ['footer', 'Kapıda kart ile ödeyin.', 'Pay by card at the door.', 'ادفع بالبطاقة عند الباب.'],
        'footer.tile_ship' => ['footer', 'Siparişiniz aynı gün içerisinde hemen kargoya verilir.', 'Orders are dispatched the same day.', 'يتم شحن الطلبات في نفس اليوم.'],
        'footer.tile_ssl' => ['footer', '256-bit SSL ile güvenli alışveriş.', '256-bit SSL encrypted checkout.', 'دفع مشفر بـ 256-بت SSL.'],
