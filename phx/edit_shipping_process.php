...
$sql = "SELECT * FROM shipping_process WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE shipping_process SET image = ?, title_1 = ?, content_1 = ?, title_2 = ?, content_2 = ?, title_3 = ?, content_3 = ? WHERE id = ?";
    $stmt = $pdo->prepare($sql);
    try {
        $stmt->execute([$image, $title_1, $content_1, $title_2, $content_2, $title_3, $content_3, $id]);
...
$page_title = 'Kargo Süreci Düzenle';
...
<div class="container mt-4">
    <div class="top-bar mb-3">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="mb-0"><i class="fas fa-edit me-2"></i>Kargo Sürecini Düzenle</h2>
            <div>
                <a href="shipping_process_list.php" class="btn btn-outline-secondary me-2">
                    <i class="fas fa-list me-1"></i> Listeye Dön
                </a>
                <a href="add_shipping_process.php" class="btn btn-outline-primary">
