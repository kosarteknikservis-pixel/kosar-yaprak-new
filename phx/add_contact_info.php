...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($count > 0) {
        $_SESSION['message'] = 'Zaten bir iletişim bilgisi mevcut, yeni kayıt eklenemez. Lütfen güncel olanı düzenleyin veya silin.';
        ...
        $sql = "INSERT INTO contact_info (image, title_1, content_1, title_2, content_2) VALUES (?, ?, ?, ?, ?)";
        $stmt = $pdo->prepare($sql);

        try {
            $stmt->execute([$image, $title_1, $content_1, $title_2, $content_2]);
...
$page_title = 'İletişim Bilgisi Ekle';
...
<div class="container mt-4">
    <div class="top-bar mb-3">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="mb-0"><i class="fas fa-plus-circle me-2"></i>İletişim Bilgisi Ekle</h2>
            <a href="contact_info_list.php" class="btn btn-outline-primary">
